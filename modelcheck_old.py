...
BTORMC = FILE_DIR / "boolector" / "build" / "bin" / "btormc" 
AVR = FILE_DIR / "avr" / "avr_pr.py"
DEFAULT_SIM = FILE_DIR / "btor2tools" / "build" / "bin" / "btorsim"

NUXMV2IL = FILE_DIR / "src" / "nuxmv2mcil.py"
IL2BTOR = FILE_DIR / "src" / "mcil2btor.py"
BTORWIT2ILWIT = FILE_DIR / "src" / "btorwit2mcilwit.py"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--modelchecker", default=str(BTORMC),
